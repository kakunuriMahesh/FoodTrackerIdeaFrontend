...
export const API_URL = "http://192.168.1.105:4000"; // Change to your backend URL
// export const API_URL = "http://https://foodtrackerideabackend.onrender.com"; // Change to your backend URL
